            ...
            <div className="bordered-container relative offerWrap overflow-hidden">
                <div className="bordered-container bg-navy-accent flex flex-wrap items-center justify-center py-5 gap-5 midcol:justify-between">
                    ...
                    <div className="flex mx-10 gap-5 items-center justify-center midcol:ml-0">
                        {url_web && (
                            <a href={`${url_web}`} target="_blank" rel="noreferrer">
                                <IconButton
                                    zoom={1.1}
                                    size={"w-12 p-3"}
                        ...
                        {url_twitter && (
                            <a href={`${url_twitter}`} target="_blank" rel="noreferrer">
                                <IconButton
                                    zoom={1.1}
                                    size={"w-12 p-3"}
                        ...
                        {url_discord && (
                            <a href={`${url_discord}`} target="_blank" rel="noreferrer">
                                <IconButton
                                    zoom={1.1}
                                    size={"w-12 p-3"}
                        ...
                        <a href={`${cdn}/research/${slug}/ResearchReport.pdf`} target="_blank" rel="noreferrer">
                            <IconButton
                                zoom={1.1}
                                size={"w-17 h-18 p-3"}
