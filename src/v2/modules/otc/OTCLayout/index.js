...
export default function Markets({ children, session }) {
    ...
    return (
        <div className="relative grow overflow-hidden flex flex-col gap-4 lg:mb-6 3xl:mb-12">
            <div>
            ...
            <div className="flex flex-col h-full gap-8 overflow-hidden lg:grid lg:grid-cols-[35%_1fr] 3xl:grid-cols-[420px_1fr] lg:grid-rows-1">
                {children}
            </div>
        </div>
    );
