    ...
    return (
        <div className={"relative"}>
            ...
            >
                <div
                    className={
                        "image-container min-w-[150px] min-h-[150px] max-w-[150px]"
                    }
                >
                    <Image
                ...
                <div className={"pl-5 py-2 flex flex-col"}>
                    <div className={"text-md font-bold flex  glow name"}>
                        {name}
                    </div>
            ...
            {!isRightPhase && (
                <div
                    className={
                        "absolute top-0 bottom-0 left-0 right-0 flex justify-center items-center flex-col"
                    }
                >
                    Can't use <span className={"text-gold glow"}>{name}</span>{" "}
                    during investment.
                </div>
            )}
            {isRightPhase &&
                ...
                used > 0 && (
                    ...
                    >
                        <span className={"text-gold glow"}>{name}</span> can be
                        used only once.
                    </div>
                )}
        </div>
