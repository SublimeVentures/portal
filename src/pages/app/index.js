    ...
    return (
        <>
            ...
            <div className="grow lg:overflow-y-auto lg:-mx-4 lg:px-4 lg:pb-6 3xl:pb-12">
                <div className="3xl:h-full 3xl:min-h-[888px] flex flex-col gap-8 xl:grid lg:grid-cols-10 lg:gap-8 3xl:gap-x-13 3xl:gap-y-10 3xl:grid-cols-6 3xl:grid-rows-9">
                    <Statistics className="xl:col-span-3 3xl:col-span-2 3xl:row-span-4" />
                    <Investments className="xl:col-span-7 3xl:col-span-4 3xl:row-span-4" />
