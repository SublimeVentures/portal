...
export default function StakingSingleSided({ session, stakingData, stakingCurrency }) {
    ...
    return (
        <div className="flex flex-col gap-4">
            <DialogTitle asChild className="w-full text-center text-lg md:text-xl">
                <h3>Staking ${stakingCurrency?.symbol}</h3>
            </DialogTitle>
            ...
            <DialogDescription className="mb-4 text-center md:text-center">
                ...
                Stake <span className="text-success-500">Based</span> Tokens only. Earn APY rewards based on tier.
            </DialogDescription>
