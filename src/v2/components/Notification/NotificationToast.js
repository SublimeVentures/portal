...
export default function NotificationToast({ t, notification }) {
    return (
        <div className="group/card py-3.5 px-5 mr-2 mt-2 rounded lg:rounded-r-xl transition-base cursor-pointer card-gradient-accent min-w-32 basis-full md:basis-2/3 lg:basis-1/2 2xl:basis-1/3 shadow-lg shadow-navy lg:shadow-none w-auto flex items-center 3xl:mr-5 3xl:mt-5 3xl:rounded-r-[27px]">
