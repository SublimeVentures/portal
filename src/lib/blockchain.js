const RPCs = {
    1: {
        main: `https://eth-mainnet.g.alchemy.com/v2/${process.env.NEXT_PUBLIC_ETH_ALCHEMY_KEY}`,
        ...
        fallback3: `https://eth-mainnet.g.alchemy.com/v2/${process.env.NEXT_PUBLIC_ETH_ALCHEMY_KEY_FALLBACK}`,
    },
    56: {
    ...
    137: {
        main: `https://polygon-mainnet.g.alchemy.com/v2/${process.env.NEXT_PUBLIC_MATIC_ALCHEMY_KEY}`,
        ...
        fallback3: `https://polygon-mainnet.g.alchemy.com/v2/${process.env.NEXT_PUBLIC_MATIC_ALCHEMY_KEY_FALLBACK}`,
    },
    43114: {
    ...
    11155111: {
        main: `https://eth-sepolia.g.alchemy.com/v2/${process.env.NEXT_PUBLIC_ETH_ALCHEMY_KEY}`,
    },
    8453: {
        main: `https://base-mainnet.g.alchemy.com/v2/${process.env.NEXT_PUBLIC_ETH_ALCHEMY_KEY}`,
    },
    84532: {
        main: `https://base-sepolia.g.alchemy.com/v2/${process.env.NEXT_PUBLIC_ETH_ALCHEMY_KEY}`,
    },
};
