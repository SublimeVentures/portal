...
export default function Privacy_based({}) {
    ...
    <span style={{ fontWeight: 400 }}>
      This Privacy Policy is designed to help you understand how{" "}
                    ...
                    <strong>our</strong>
                    <span style={{ fontWeight: 400 }}>
      ”) collects, uses, and shares your personal information on the BasedVC
      Platform and to help you understand and exercise your privacy
      rights.&nbsp;
    </span>
                </p>
                <p>
    <span style={{ fontWeight: 400 }}>
      <br />
                    ...
                    <span style={{ fontWeight: 400 }}>
      Capitalized terms not defined in this Privacy Policy have the meaning set
      forth in the Terms of Service&nbsp;
                ...
                <p>
    <span style={{ fontWeight: 400 }}>
      This Privacy Policy applies to personal information processed by BasedVC
      on&nbsp;the BasedVC website and interface located at{" "}
    </span>
      ...
      ”) and the corresponding discord server (“
                    ...
                    <span style={{ fontWeight: 400 }}>
      ”), including without limitation the purchase of certain digital assets in
      the form of non-fungible cryptocurrency tokens (“
    </span>
                    <strong>NFTs</strong>
                    <span style={{ fontWeight: 400 }}>
      ”) on the decentralized blockchains on which the NFTs are recorded (each,
      a “
    </span>
                    <strong>Blockchain</strong>
                    <span style={{ fontWeight: 400 }}>
      ”), as well as the access to our online services and software provided on
      or in connection with those services that are accessible via the Website
      and the Discord. To make this Privacy Policy easier to read, the Website,
      the Discord, and the services are collectively called the “
    </span>
                    <strong>Services</strong>
                    <span style={{ fontWeight: 400 }}>
      .” &nbsp;For clarity, the Services, the Website, and the Discord do not
      include the Kongz Capital smart contract, or any other aspect of the
      Ethereum or other blockchain-based network with which the Website, Discord
      ...
      <br />
                ...
                <ul>
                    <li style={{ fontWeight: 400 }}>
                        ...
                        <span style={{ fontWeight: 400 }}>
        . In order to engage in transactions on the Services, you will need to
        provide us with access to or information about your digital wallet. As
        you use the Services, we may collect personal information and details
        associated with the transactions you are involved with.
      </span>
                    </li>
                    <li style={{ fontWeight: 400 }}>
                        <strong>Account Information</strong>
                        <span style={{ fontWeight: 400 }}>
        . If you choose to connect your account to the Services or create an
        account with us and provide such information, we or our service
        providers may collect your email, username, and ETH/MATIC/BNB address.
      </span>
                    </li>
                    <li style={{ fontWeight: 400 }}>
        ...
        Services, register for our newsletter or marketing, request customer or
        ...
        (e.g., commenting functionalities, forums, blogs, and social media
        pages). Any personal information you provide on the public sections of
        ...
        include personal information.
                    ...
                    <li style={{ fontWeight: 400 }}>
                        ...
                        <span style={{ fontWeight: 400 }}>
        . We may collect personal information you provide for any sweepstakes or
    ...
    <span style={{ fontWeight: 400 }}>
      ...
      Services:
        ...
        MAC address, cookie identifiers, mobile carrier, mobile advertising and
        other unique identifiers, browser or device information, location
        ...
        visit before, during and after using our Services, information about the
        links you click, the types of content you interact with, the frequency
        and duration of your activities, and other information about how you use
        our Services.
      </span>
                    </li>
                    <li style={{ fontWeight: 400 }}>
        ...
        in our Services that collects information about engagement on our
        Services. The use of a pixel tag allows us to record, for example, that
        a user has visited a particular web page or clicked on a particular
    ...
    <span style={{ fontWeight: 400 }}>
      Our uses of these Technologies fall into the following general categories:
        ...
        applications, and tools that are required to identify irregular website
        behavior, prevent fraudulent activity and improve security or that allow
        ...
        specified preferences, interests, or past items viewed; and
      </span>
                    </li>
                </ul>
                <ul>
      ...
      <span style={{ fontWeight: 400 }}>
        ...
        analytics information on our Services.
                ...
                <ul>
                    <li style={{ fontWeight: 400 }}>
                        ...
                        <span style={{ fontWeight: 400 }}>
        . For more information about how Google uses your data (including for
        its own purposes, e.g. for profiling or linking it to other data),
        please visit&nbsp;
      </span>
        ...
        information, please click&nbsp;
                ...
                <ul>
                    <li style={{ fontWeight: 400 }}>
                        ...
                        <strong>&nbsp;</strong>
                        <span style={{ fontWeight: 400 }}>
        social media buttons such as Facebook, Twitter and LinkedIn (that might
        include widgets such as the “share this” button or other interactive
        mini programs). These features may collect your IP address, which page
        you are visiting on our Services, and may set a cookie to enable the
        feature to function properly. Your interactions with these platforms are
        governed by the privacy policy of the relevant corporate entities
        ...
        store, a third-party login service, or a social networking Website, we
    ...
    <span style={{ fontWeight: 400 }}>
      ...
      audiences advertising, and “interest-based” or “personalized advertising,”
      ...
      are described below.
                ...
                <ul>
                    <li style={{ fontWeight: 400 }}>
                        ...
                        <span style={{ fontWeight: 400 }}>
        &nbsp;If you elect to sell, purchase, or trade any NFTs on the Kongz
        Capital Platform, any financial transactions that you engage in will be
        conducted solely through the Blockchain network governing such NFT.
        Information about your transactions will be provided to the applicable
        Blockchain and may be accessible to third parties due to the nature of
        the Blockchain.
      </span>
                    </li>
                    <li style={{ fontWeight: 400 }}>
                        <strong>
                            Other Users of the Services and Parties You Transact With.
                        </strong>
                        <span style={{ fontWeight: 400 }}>
        &nbsp;Some of your personal information may be visible to other users of
        the Services. In addition, to complete NFT transactions via the
        Services, we will need to share some of your personal information with
        the person or company that you are transacting with. &nbsp; &nbsp;
                            &nbsp;
      </span>
                    </li>
                    <li style={{ fontWeight: 400 }}>
        ...
        third-party websites and/or third-party applications, including, but not
        limited to, third-party electronic wallet extensions. Once your personal
        information has been shared with a third-party website or a third-party
        application, it will also be subject to such third party’s privacy
        policy. We encourage you to closely read each third-party website or
        third-party application privacy policy before sharing your personal
        information or otherwise interacting with them. Please note that we do
        not control and we are not responsible for the third-party websites or
        ...
        includes service providers that provide us with IT support, hosting,
        payment processing, customer service, and related services.
      </span>
                    </li>
                    <li style={{ fontWeight: 400 }}>
        ...
        share your personal information to business partners with whom we
        jointly offer products or services.
                    ...
                    <li style={{ fontWeight: 400 }}>
                        ...
                        <span style={{ fontWeight: 400 }}>
        . We may share your personal information with members of our corporate
        family.
      </span>
                    </li>
                    <li style={{ fontWeight: 400 }}>
        ...
        ”) and software development kits (“
                        ...
                        <strong>SDKs</strong>
                        <span style={{ fontWeight: 400 }}>
        ”) as part of the functionality of our Services. For more information
    ...
    <span style={{ fontWeight: 400 }}>
      ...
      required or appropriate to: comply with law enforcement or national
    ...
    <span style={{ fontWeight: 400 }}>
      ...
      determined by applicable law and are described below.
        ...
        (e.g., communications regarding our Services or updates to our Terms of
        ...
        Please note that we do not respond to or honor DNT signals or similar
        ...
        permits. However, if you adjust your preferences, our Services may not
        work properly. Please note that cookie-based opt-outs are not effective
    ...
    <span style={{ fontWeight: 400 }}>
      ...
      these and learn more about targeted advertising and consumer choice and
    ...
    <span style={{ fontWeight: 400 }}>
      ...
      . In accordance with applicable law, you may have the right to:
        ...
        personal information; or (iii) receiving an electronic copy of personal
        ...
        information to another company (aka the right of data portability);
                    ...
                    <li style={{ fontWeight: 400 }}>
                        ...
                        <span style={{ fontWeight: 400 }}>
        of your personal information where it is inaccurate or incomplete. In
        some cases, we may provide self-service tools that enable you to update
    ...
    <span style={{ fontWeight: 400 }}>
      ...
      set forth in Section 15 below. We will process such requests in accordance
      with applicable laws.
                ...
                <p>
    <span style={{ fontWeight: 400 }}>
      We take steps designed to ensure that your information is treated securely
      and in accordance with this Privacy Policy.
                    ...
                    <span style={{ fontWeight: 400 }}>
      Unfortunately, no system is 100% secure, and we cannot ensure or warrant
      the security of any information you provide to us. To the fullest extent
    ...
    <span style={{ fontWeight: 400 }}>
      ...
      electronically by posting a notice on our Services, by mail or by sending
      an email to you.&nbsp;
    </span>
                </p>
                <p>&nbsp;</p>
    ...
    <span style={{ fontWeight: 400 }}>
      ...
      laws. &nbsp;
                ...
                <p>
    <span style={{ fontWeight: 400 }}>
      This Supplemental California Privacy Policy only applies to our processing
      of personal information that is subject to the California Consumer Privacy
      Act of 2018 (“
    </span>
                    <strong>CCPA</strong>
                    <span style={{ fontWeight: 400 }}>
      ”). The CCPA provides California residents with the right to know what
      categories of personal information Kongz Capital has collected about them
      and whether Kongz Capital disclosed that personal information for a
    ...
    <span style={{ fontWeight: 400 }}>
      <br />
                ...
                <p>
                    ...
                    <span style={{ fontWeight: 400 }}>
      For purposes of the CCPA, Kongz Capital does not “sell” personal
      information, nor do we have actual knowledge of any “sale” of personal
      information of minors under 16 years of age.&nbsp;That said, we may share
      information with third-party advertising partners for the purpose of
      promoting our Services as described above, including for cross-context
      behavioral advertising. To the extent that such sharing is considered a
      “sale” under the CCPA, you may opt-out of having your personal information
      shared with such advertising partners by following the instructions found
      above in the section titled,&nbsp;
    </span>
                    <a href="https://impostors.gg/#id.2xcytpi">
      <span style={{ fontWeight: 400 }}>
        Your Privacy Choices and Rights &gt; Your Privacy Choices &gt; Cookies
    ...
    <span style={{ fontWeight: 400 }}>
      ...
      of certain personal information to third parties who intend to license or
      sell that personal information. You can exercise this right by contacting
      us as set forth below with the subject line “Nevada Do Not Sell Request”
      and providing us with your name and the email address associated with your
      account. Please note that we do not currently sell your personal
    ...
    <span style={{ fontWeight: 400 }}>
      ...
      forth below. &nbsp;If we learn that we have collected a child’s personal
      information in violation of applicable law, we will promptly take steps to
    ...
    <span style={{ fontWeight: 400 }}>
      ...
      United Kingdom you have the right to lodge a complaint with a supervisory
    ...
    <span style={{ fontWeight: 400 }}>
      ...
      please contact us via our&nbsp;BasedVC Discord&nbsp;or
