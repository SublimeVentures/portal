...
export default function Privacy_based({}) {
    ...
    <span style={{ fontWeight: 400 }}>
      ...
      include the BasedVC smart contract, or any other aspect of the Ethereum or
      other blockchain-based network with which the Website, Discord and
      Services interact.
    </span>
                </p>
                <p>
      ...
      are described below.
                ...
                <ul>
                    <li style={{ fontWeight: 400 }}>
                        ...
                        <span style={{ fontWeight: 400 }}>
        &nbsp;If you elect to sell, purchase, or trade any NFTs on the BasedVC
        Platform, any financial transactions that you engage in will be
    ...
    <span style={{ fontWeight: 400 }}>
      ...
      categories of personal information BasedVC has collected about them and
      whether BasedVC disclosed that personal information for a business purpose
    ...
    <span style={{ fontWeight: 400 }}>
      <br />
                ...
                <p>
                    ...
                    <span style={{ fontWeight: 400 }}>
      For purposes of the CCPA, BasedVC does not “sell” personal information,
      nor do we have actual knowledge of any “sale” of personal information of
      minors under 16 years of age.&nbsp;That said, we may share information
      with third-party advertising partners for the purpose of promoting our
      Services as described above, including for cross-context behavioral
      advertising. To the extent that such sharing is considered a “sale” under
      the CCPA, you may opt-out of having your personal information shared with
      such advertising partners by following the instructions found above in the
      section titled,&nbsp;
    </span>
