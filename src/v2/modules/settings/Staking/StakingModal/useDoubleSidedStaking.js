...
export default function useDoubleSidedStaking({ isOpen, userId }) {
    ...
    const stakeEth = watch("eth");
    const stakeValue = stakeBased + stakeEth;
    ...
    const blockchainInteractionData = useMemo(() => {
        return {
            ...
            params: {
                ...
                liquidity: stakeValue,
                allowance: stakeValue,
                buttonText: "Stake",
