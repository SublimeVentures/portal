export default function Highlights() {
    return (
        <div className="bg-black font-heading uppercase flex flex-col items-center justify-center text-white md:pt-10 ">
            <div className={" max-w-[80%] mx-auto flex flex-col items-center justify-center accentFont"}>
                ...
                <div className={"mt-10 text-xl text-center text-primary"}>Bored & Mutant Ape exclusive</div>
                <div className={"-mb-10"}>
