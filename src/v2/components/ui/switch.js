...
const Switch = forwardRef(({ className, ...props }, ref) => (
    <SwitchPrimitives.Root
        className={cn(
            ...
            "data-[state=checked]:border-primary data-[state=unchecked]:border-white",
            className,
        )}
        {...props}
        ref={ref}
    >
        <SwitchPrimitives.Thumb
            className={cn(
                ...
                "data-[state=checked]:translate-x-6 data-[state=checked]:bg-primary data-[state=unchecked]:bg-white",
            )}
        />
    </SwitchPrimitives.Root>
));
