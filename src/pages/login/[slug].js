            ...
            <div className={"flex justify-between flex-wrap gap-10 w-full  md:w-2/3"}>
                <div className="flex flex-1 flex-col p-10 sm:p-10 sm:w-max font-accent blurred glareBg bg-black lg:flex-row ">
                    <div className="flex flex-col">
                        <div className="text-3xl font-bold"><span className={"text-app-success"}>Partner</span> Login</div>
                        <div className="pt-3">
                            <div>Unlock exclusive partner privileges by connecting a wallet with your Partner NFT. Ensure you hold the NFT or have been granted delegated access to journey forward.</div>
                        ...
                        <div className="flex flex-col gap-5 justify-end flex-1 pt-10 lg:mt-0">
                            <RoundButton text={'Connect Wallet'} isLoading={isLoginLoading}  isLoadingWithIcon={true} isWide={true} zoom={1.1} size={'text-sm sm'} icon={<WalletIcon className={ButtonIconSize.hero}/> } handler={() => { handleConnect() }} />
                        </div>
                    </div>
                </div>
            </div>
