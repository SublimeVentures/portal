...
const EmptyInvestmentsEnhanced = () => {
    return (
        <Card variant="none" border="none" className="relative h-full w-full flex flex-col items-center justify-center gap-4 grow bg-empty-investment-top-pattern bg-cover bg-center bg-no-repeat">
