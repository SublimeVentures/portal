...
const TabsTrigger = forwardRef(({ className, ...props }, ref) => (
    <TabsPrimitive.Trigger
        ...
        className={cn(
            ...
            "text-white/30 bg-transparent border border-primary/20 hover:text-white/40 hover:border-primary/40",
            "data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:shadow data-[state=active]:border-primary-800",
            className,
        )}
        {...props}
    />
