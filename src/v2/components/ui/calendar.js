    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                nav_button: cn( buttonVariants({ variant: "link" }), "h-7 w-7 bg-transparent p-0 text-foreground hover:text-foreground"),
                nav_button_previous: "absolute left-1",
                nav_button_next: "absolute right-1",
                table: "w-full border-collapse space-y-1",
                head_row: "flex",
                head_cell: "w-full text-foreground text-[14px] font-medium rounded",
                ...
                day: cn(buttonVariants({ variant: "ghost" }), "p-0 h-10 w-10 font-normal border border-transparent aria-selected:opacity-100 hover:border-accent"),
