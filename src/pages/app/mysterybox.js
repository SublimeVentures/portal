    ...
    return (
        <>
            ...
            <div className="grow flex flex-col items-start justify-center lg:py-6 3xl:py-12">
                <div className="lg:w-1/2 3xl:w-[532px]">
                    <div className="flex flex-col items-start lg:gap-2 3xl:gap-4 mb-10 lg:mb-4 3xl:mb-10 pt-10 lg:pt-0">
                    ...
                    <BackdropCard className="mb-5">
                        <DefinitionList className="grid-cols-2 w-full lg:w-2/3">
                    ...
                    {mysteryBoxOwnedAmount > 0 && (
                        <BackdropCard className="!flex-row">
                            <figure className="w-2/5 lg:w-1/3">
                                <Image
                                    src="/img/icon-chest.webp"
                                    className="rounded-md w-full lg:size-18 lg:-my-2"
                                    alt="Mystery Box"
                                    width={72}
                                    height={72}
                                />
                            </figure>
                            <div className="w-3/5 lg:w-2/3 flex flex-col lg:flex-row gap-5 lg:items-center">
                                <DefinitionList className="lg:w-1/2">
