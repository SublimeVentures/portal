    ...
    const removeWallet = async () => {
        ...
        try {
            signature = await signMessageFn({
                ...
                message: 'Upon removing a wallet from my account, I acknowledge that it will no longer have access to execute transactions or manage assets on my behalf. This action also frees the wallet for potential association with a different account, under respective authorization norms.',
            })
        } catch (error) {
            setProcessing(false)
    ...
    const contentStake = () => {
        return (
            <div className={"min-w-[300px]"}>
                <div>
                    Switch to wallet you want to remove, and sign message.<br/>
