            ...
            >
                ...
                <div className={"flex flex-row z-10 "}>
                    <div className={"flex flex-1 items-end text-sm pb-5 "}>
                        <div
                            className={
                                "offerTime w-full px-5 flex justify-between h-8 items-center color"
                            }
                        >
                            <div>
                                {id === 1 ? "Non-stackable" : "Stackable"}
                            </div>
                            <div>
                                Price: {price}{" "}
                                {isBased ? "USD" : currency.symbol}
                            </div>
                        </div>
                    </div>
                </div>
                <div className="flex flex-1 flex-col text-left ">
                    <div className={"px-10 flex flex-1 flex-col "}>
                        <div className="text-xl font-bold flex  glow pt-2">
                            {name}
                        </div>
                        <div className="text-sm flex flex-1 mt-2 pb-5 color ">
                            {description}
                        </div>
                        <div
