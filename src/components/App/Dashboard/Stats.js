...
import { IoLogoBitcoin as BitcoinIcon } from "react-icons/io5";
import { IoKey as KeyIcon } from "react-icons/io5";
import { IoStatsChartOutline as ChartIcon } from "react-icons/io5";
    ...
    return (
        <div className="flex grid grid-cols-12 mt-5 gap-y-10 mobile:gap-10 ">
            <div className="col-span-12 mt-5 flex sm:col-span-4 sm:mt-0">
                <RoundContainer
                    isSuccess={true}
                    icon={<BitcoinIcon className="w-14 -mt-2" />}
                    content={projectInvestedWidget()}
                    forcedClass={"min-h-[150px]"}
                />
            </div>
            <div className="col-span-12 mt-5 flex sm:col-span-4 sm:mt-0">
                <RoundContainer
                    isSuccess={false}
                    icon={<KeyIcon className="w-10 -mt-2" />}
            ...
            <div className="col-span-12 mt-5 flex sm:col-span-4 sm:mt-0">
                <RoundContainer
                    isSuccess={false}
                    icon={<ChartIcon className="w-10 -mt-2" />}
                    content={apyWidget()}
                    forcedClass={"min-h-[150px]"}
                />
            </div>
