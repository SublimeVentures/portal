...
const UpgradeBanner = ({ isPremium = false, className }) => (
    <Card variant="none" border="none" className={cn("p-0 min-w-[460px] bg-upgrade-to-premium-banner-pattern bg-cover bg-center bg-no-repeat", { "bg-premium-banner": isPremium }, className)}>
