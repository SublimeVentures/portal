...
function IndexPage() {
    return (
        <>
            ...
            <div className="3xl:grow flex flex-col gap-8 lg:-mx-4 lg:px-4 lg:pb-6 lg:grid lg:grid-cols-10 lg:overflow-y-auto lg:gap-8 3xl:gap-x-13 3xl:gap-y-10 3xl:grid-cols-6 3xl:pb-12 3xl:overflow-hidden 3xl:grid-rows-9">
