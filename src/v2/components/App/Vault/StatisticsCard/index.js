...
import usersSvg from "@/v2/assets/svg/users.svg";
...
export const RewardStatisticCard = partiallyApply(StatisticCard, { title: "Total Rewards", icon: courtSvg });

export const InvitersStatisticCard = partiallyApply(StatisticCard, { title: "Total Inviters", icon: usersSvg });
