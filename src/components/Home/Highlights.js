  ...
  <div className="highlightGradient flex justify-center text-white md:pt-10">
    <div className="px-10 py-25 flex flex-col gap-10 flex-1 lg:flex-row md:mx-auto md:justify-between lg:flex-row xl:max-w-[1400px] ">
      <div className="lg:max-w-[350px] flex flex-col">
        ...
        <div className={` mt-10 font-light flex flex-1`}>Harness the power of automation and maximize your investment potential with our cutting-edge on-chain platform. Our smart contracts are designed to streamline the investment process, eliminating the need for lengthy KYC procedures. </div>
      </div>
      <div className="lg:max-w-[350px] flex flex-col">
      ...
      <div className="lg:max-w-[350px] flex flex-col">
        ...
        <div className={`mt-10 font-light flex flex-1`}>No need to reinvent the wheel or try to be too clever. We close out rounds in the hottest early stage web3 investments alongside the world's top VC.</div>
      </div>
    </div>
