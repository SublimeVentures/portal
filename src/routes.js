...
const ExternalLinksBased = {
    BOOKING_SYSTEM:
        "https://info.basedvc.fund/Allocation-Booking-System-2f93893f882c49d0ab305159aa7099c4",
    OFFER_PHASES:
        "https://info.basedvc.fund/Offer-phases-cf284a30c16f4586a8f2fa6b49df1e8d",
    AFTER_INVESTMENT:
        "https://info.basedvc.fund/After-Investing-7a44086b917545029d95574c53c66a7d",
    SUPPORTED_NETWORKS:
        "https://info.basedvc.fund/Supported-networks-safe-gas-3d50096070d54efebae0590d02acbcdb",
    UPGRADES:
        "https://info.basedvc.fund/Upgrades-adb5bd92e38644ef95433d23be612bf1", //todo: fix images
    LOOTBOX:
        "https://info.basedvc.fund/MysteryBox-0b34290a907543049b2cef882ba72e5c", //todo: fix
    HOW_TO_ACCESS:
        "https://info.basedvc.fund/How-to-access-3VC-f40a1142d93f4b0ba38e13114189a877",
    DELEGATED_ACCESS:
        "https://info.basedvc.fund/Delegated-access-dc60abd8a5654641a7bd77d537256aa7",
    ...
    WHALE_CLUB:
        "https://info.basedvc.fund/3VC-Whale-Club-5fea374623c1493d8af2b4b04914ab3e",
...
const ExternalLinksCitCap = {
    ...
    GETBYTES:
        "https://app.uniswap.org/#/swap?outputCurrency=0xa19f5264f7d7be11c451c093d8f92592820bea86",
    STAKE_NT: "https://neotokyo.codes/profile",
    BOOKING_SYSTEM:
        "https://info.citizencapital.fund/overview/faq#how-does-allocation-booking-system-works",
    OFFER_PHASES:
        "https://info.citizencapital.fund/overview/the-investment-process#the-investment-phases-are-as-follows",
    AFTER_INVESTMENT:
        "https://info.citizencapital.fund/overview/managing-your-investments",
    ...
    OTC_ANNOUNCE:
        "https://discord.com/channels/884204406189490176/1185352947308171324",
    STAKING:
        "https://info.citizencapital.fund/BYTES-Staking-Requirement-f1621bfe909b41d797fd77ca784a8fa0",
};
...
const ExternalLinksCyberKongz = {
    ...
    GET_BANANA_ETH:
        "https://app.uniswap.org/#/swap?outputCurrency=0x94e496474f1725f1c1824cb5bdb92d7691a4f03a",
    GET_BANANA_MATIC:
