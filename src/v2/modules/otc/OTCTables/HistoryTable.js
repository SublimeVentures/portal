    ...
    return (
        <Card variant="static" className="flex flex-col items-center justify-center h-full gap-4 text-white p-4">
            <div className="h-full w-full flex flex-col gap-4 justify-center items-center bg-white/5 py-10">
                <CardTitle className="text-base md:text-lg font-medium text-white">No offers history found</CardTitle>
                <CardDescription className="max-w-md text-xs md:text-sm font-light text-white/50 text-center">
                    The offers history is currently empty. This space will fill when there is more activity. Check back
                    at a later time.
                </CardDescription>
            </div>
        </Card>
