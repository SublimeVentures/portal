    ...
    <div className="w-full z-10">
      <div className="px-10 py-25 flex flex-col gap-10 flex-1 lg:flex-row md:mx-auto md:justify-between lg:flex-row xl:max-w-[1400px] ">
        <div className="lg:max-w-[350px] flex flex-col">
          ...
          <div className={`mt-10 font-light flex flex-1`}>We are led by a team with decades of experience advising, investing and consulting in web3. Our team of analysts, researchers, advisors and consultants work hard to bring you the most exclusive opportunities.</div>
        </div>
        <div className="lg:max-w-[350px] flex flex-col">
          <div className="font-accent text-xl font-md mt-15 flex items-end h-[58px] lg:mt-0">Equality</div>
          <div className=" mt-10 font-light flex flex-1">We believe investments should
        ...
        <div className="lg:max-w-[350px] flex flex-col">
          ...
          <div className=" mt-10 font-light flex flex-1">The anon, degen world of web3 is built upon trust.
