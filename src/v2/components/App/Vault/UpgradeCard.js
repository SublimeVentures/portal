...
const UpgradeCard = ({ isPremium = false }) => (
    <Card
        variant="none"
        border="none"
        className="py-8 relative flex flex-col items-center grow aspect-[7/12] bg-upgrade-to-premium-pattern bg-cover bg-center bg-no-repeat"
    >
        <IconButton
            name="Upgrade"
            shape="circle"
        ...
        {isPremium ? (
            <>
                <CardTitle className="mt-auto mb-2 text-6xl font-normal italic text-accent text-center">
                    Upgrade to
            ...
            <div className="mt-auto">
                ...
                <dl>
                    <div className="flex items-center">
                        ...
                        <dd className="ml-auto h-6 w-6 flex items-center justify-center bg-accent/[.2] text-accent rounded-t">
                            1
                        </dd>
                    </div>
                    <div className="flex items-center">
                        <dt className="mr-2">Increased Allocation</dt>
                        <dd className="ml-auto h-6 w-6 px-1.5 flex items-center justify-center bg-accent/[.2] text-accent rounded-b">
                            5
                        </dd>
                    </div>
                </dl>
