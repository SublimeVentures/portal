...
const BlockchainSteps = ({data}) => {
    ...
    const allowance_methodReset = steps.allowance ? getMethod(METHOD.ALLOWANCE, token, {...params, allowance: 0}) : {method: {stop:true}}
    const allowance_method = steps.allowance ? getMethod(METHOD.ALLOWANCE, token, params): {method: {stop:true}}
