...
export function DatePicker({ label = "Select date", variant = "tertiary", align = "left", date = null, onSetDate, className, ...props }) {    
    return (
        <Popover>
            ...
            <PopoverContent align={align} className="px-4 py-6 w-auto border-transparent text-foreground bg-navy-600 [box-shadow:0px_0px_58px_rgba(0,_0,_0,_0.39)]">
