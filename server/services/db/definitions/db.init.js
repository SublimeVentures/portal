...
function setupAssociationsForParticipant(sequelize, participantModel) {
    ...
    partner.hasMany(participantModel, { foreignKey: "partnerId", sourceKey: "id" });
    participantModel.belongsTo(partner, { foreignKey: "partnerId", sourceKey: "id" });

    partner.hasMany(participantModel, { foreignKey: "tenantId", sourceKey: "id" });
    participantModel.belongsTo(partner, { foreignKey: "tenantId", sourceKey: "id" });
}
...
function applyExtraSetup(sequelize) {
    ...
    notification.belongsTo(partner, { foreignKey: "tenantId", targetKey: "id" });
    ...
    offer.hasOne(monitor, { foreignKey: "offerId" });
    monitor.belongsTo(offer, { foreignKey: "offerId" });
    ...
    // user model
    partner.hasMany(user, { foreignKey: "registeredWith" });
    user.belongsTo(partner, { foreignKey: "registeredWith" });
