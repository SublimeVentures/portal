...
const AlertTitle = forwardRef(({ className, ...props }, ref) => (
    ...
    <h4 ref={ref} className={cn("mb-1 text-2xl font-semibold leading-none tracking-tight", className)} {...props} />
));
AlertTitle.displayName = "AlertTitle";

const AlertDescription = forwardRef(({ className, ...props }, ref) => (
    <div ref={ref} className={cn("text-md font-light[&_p]:leading-relaxed", className)} {...props} />
));
