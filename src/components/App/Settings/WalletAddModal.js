    ...
    const addWallet = async () => {
        ...
        try {
            signature = await signMessageFn({
                ...
                message:
                    "I acknowledge that all linked wallets will have the capability to perform actions on my behalf, including selling assets and claiming allocations associated with my account.",
            });
        } catch (error) {
            setProcessing(false);
